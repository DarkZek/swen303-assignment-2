...
import { cart, checkmarkSharp, chevronBackOutline, trashOutline, heart, cloud, heartCircleOutline } from "ionicons/icons";
            ...
            <IonHeader>
				<IonToolbar>
                    ...
                    <IonButtons slot="end">
						...
						<IonButton size="Large"  className={ styles.favouriteButton } color="danger" routerLink="/favourites">
