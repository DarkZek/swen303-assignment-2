...
import { cart, checkmarkSharp, chevronBackOutline, trashOutline, heart, cloud, heartOutline } from "ionicons/icons";
            ...
            <IonHeader>
				<IonToolbar>
                    ...
                    <IonButtons slot="end">
						...
						<IonButton size="default"  className={ styles.favouriteButton } color="danger" routerLink="/favourites">
